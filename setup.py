...
MODULE = 'shipment_invoice_report_from_shipment'
PREFIX = 'nantic'
MODULE2PREFIX = {}
OWNER = {
    'nantic':'NaN-tic',
...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-shipment_invoice_report_from_shipment',
    download_url='https://github.com:nantic/trytond-shipment_invoice_report_from_shipment.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-shipment_invoice_report_from_shipment.git'
    },
    classifiers=[
